<template>
  <v-card color="grey lighten-4" light>
    <v-card-text>
      ...
      <content-section v-if="educations" title="Experience">
    ...
    educations: [
      {
        from: "2013",
        to: "2018",
        title: "Working and researching in the junior team",
      ...
      },
      {
        ...
        location: " Azad Islamic university, Qazvin, Iran",
